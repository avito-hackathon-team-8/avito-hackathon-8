...
обращаются к запущенному Compose api-service и создают изолированных пользователей
в Postgres.
...
make up
cd api-service
RUN_API_SERVICE_E2E=1 GOCACHE="${TMPDIR:-/tmp}/avito-go-build-cache" go test ./test/daily_report -count=1 -v
```
