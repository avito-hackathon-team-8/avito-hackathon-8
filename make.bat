...
if /i "!COMMAND!"=="lint-api-service" goto lint_api_service
if /i "!COMMAND!"=="lint-daily-tasks-service" goto lint_daily_tasks_service
if /i "!COMMAND!"=="lint-pet-state" goto lint_pet_state
...
echo make.bat migrate                    Apply database migrations
...
if errorlevel 1 exit /b !errorlevel!
call :run_lint_backend api-service
if errorlevel 1 exit /b !errorlevel!
call :run_lint_backend daily-tasks-service
if errorlevel 1 exit /b !errorlevel!
call :run_lint_backend pet-state-service
exit /b !errorlevel!
...
:run_lint_backend
docker run --rm -v "%CD%:/app:ro" -w "/app/%~1" golangci/golangci-lint:v2.12.2-alpine golangci-lint run --config ../.golangci.yaml
exit /b !errorlevel!
