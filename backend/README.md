...
Backend игрового слоя для Авито. Сервис авторизует пользователей, хранит состояние питомца, обрабатывает задания и события активности, начисляет листья, выдаёт награды и отправляет обновления клиенту по WebSocket.
