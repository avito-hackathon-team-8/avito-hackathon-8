...
export const GamificationCard = ({
  ...
  return (
    <article
      className={clsx(styles.card, styles[`card_${variant}`], className)}
      {...wrapperProps}
    >
      ...
      <Typography className={styles.card__description} variant="caption">
        {description}
      </Typography>

      <img
        className={clsx(styles.card__img, imageProps.className)}
        {...imageProps}
      />
    </article>
  );
