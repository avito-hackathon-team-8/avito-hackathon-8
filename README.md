...
### Ломаев Игорь - Frontend-разработчик

- Разработка.

**Репозиторий с кодом участника:** [Frontend](https://github.com/avito-hackathon-team-8/avito-hackathon-8)

### Болдаков Владимир - Backend-разработчик

- Разработка.

**Репозиторий с кодом участника:** [Backend](https://github.com/avito-hackathon-team-8/avito-hackathon-8)

### Грицун Артем - Backend-разработчик

- Разработка.

**Репозиторий с кодом участника:** [Backend](https://github.com/avito-hackathon-team-8/avito-hackathon-8)

### Лафуткин Андрей - Backend-разработчик
